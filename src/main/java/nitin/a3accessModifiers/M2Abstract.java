...
public abstract class M2Abstract {
    ...
    // abstract call cannot be instantiated. Thus if we don't want a class to be instantiated,
    // declare it as abstract.

    // If a class has at least one abstract method, The class has to be declared as abstract.

    // even if there are no abstract methods in a class, we can still declare it as abstract. eg.
    // HTTPServlet
