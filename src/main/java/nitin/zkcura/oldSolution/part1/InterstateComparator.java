package nitin.zkcura.oldSolution.part1;
 ...
 *
 * <p>Based on the Assumption given in the Exercise, The same city will not appear more than once in
 * the input file and thus it can safely be deduced that The total number of times an interstate
 * name appears in the input file is equal to the total number of different cities is passes through
 */
