...
public class A12ThenCombine {
    ...
    /**
     * Completion stage method used to combine Independent Completable Futures Takes two arguments
     * CompletionStage, BiFunction Returns a CompletableFuture
     *
     * @param args
     */
    ...
    public static CompletableFuture<String> fullNameService() {
        ...
        CompletableFuture<String> lastName =
                ...
                firstName
                        .thenCombine(
                                ...
                                (fn, ln) ->
                                        getAppendedString(
                                                fn,
                                                ln)) // Completion stage is the last name service.
    ...
    public static CompletableFuture<String> fullNameWithGreetingAndGoodByesService() {
        ...
        CompletableFuture<String> intro =
                CompletableFuture.supplyAsync(
                        () -> {
                            delay(1000);
        ...
        CompletableFuture<String> extro =
                CompletableFuture.supplyAsync(
                        () -> {
                            delay(1100);
        ...
        CompletableFuture<String> fullNameCompletableFuture =
                intro.thenCombine(
                                ...
                                (previous, current) ->
                                        getAppendedString(
                                                previous,
                                                current)) // previous is greeting, current is first
                        // name
                        .thenCombine(
                                lastName,
                                (fn, ln) ->
