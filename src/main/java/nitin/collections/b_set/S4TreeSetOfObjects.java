...
public class S4TreeSetOfObjects {
    ...
    public static void main(String[] args) {
        ...
        Car a =
                new Car(
                        ...
                        new ArrayList<String>(
                                Arrays.asList("AWD", "Leather", "Sun Roof", "Grey Interior")));
        Car b =
                new Car(
                        "Toyota",
                        "RAV4",
                        new int[] {03, 2019},
                        new ArrayList<String>(
                                Arrays.asList("2WD", "Cotton", "Sun Roof", "Grey Interior")));
        Car c =
                new Car(
                        "Honda",
                        "Accord",
        ...
        Set<Car> set =
                new TreeSet<>(
                        Comparator.comparing(Car::getMake) // Default Natural Sorting Order
