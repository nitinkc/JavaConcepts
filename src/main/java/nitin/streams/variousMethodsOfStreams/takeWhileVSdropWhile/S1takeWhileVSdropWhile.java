 ...
 *
 * <p>takeWhile() like filter() method will take elements from the Stream as long as predicate
 * returns true. If predicate returns false, at that point onwards remaining elements won't be
 * processed, i.e rest of the Stream is discarded.
 */
public class S1takeWhileVSdropWhile {
    public static void main(String[] args) {
        ...
        List<Integer> l3 = list.stream().dropWhile(x -> x % 3 != 0).collect(Collectors.toList());
