...
/**
 * Created by Nitin Chaurasia on 1/30/18 at 8:37 PM.The file name should be
 * application-datasource-h2.properties P1 -> if number is > 10 P2 -> is even
 *
 * <p>P1.negate() P1.and(P2) P1.or(P2)
 */
public class PDF2PredicateJoining {
    public static void main(String[] args) {
        ...
        System.out.println("ARRAY : " + List.of(x));
