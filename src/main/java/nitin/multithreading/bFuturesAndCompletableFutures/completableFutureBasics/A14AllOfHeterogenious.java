...
public class A14AllOfHeterogenious {
    public static void main(String[] args) {
        ...
        CompletableFuture<List<Beer>> beerCompletableFuture = CompletableFuture.supplyAsync(() -> InternetUtilities.getBeers(2));
        CompletableFuture<List<Vehicle>> vehicleCompletableFuture = CompletableFuture.supplyAsync(() -> RestGETReadUtility.getRandomVehicles(1));
        ...
        CompletableFuture<List> allFutureResults = resultantCf.thenApply(t -> completableFutures
