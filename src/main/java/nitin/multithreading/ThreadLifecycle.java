...
public class ThreadLifecycle {
    public static void main(String[] args) {
        ...
        try {
            // If main thread doesn't wait long enough, to allow runnable tasks to finish, the main
            // thread will wait
        ...
        System.out.println(
                "State: " + thread.getState()); // TIMED_WAITING or TERMINATED, depending on timing
    }
}
