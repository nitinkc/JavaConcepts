...
public class FolderExamples {
    ...
    public static void listExamples() {
        ...
        FolderUtils.printPathsInFolder(".", p -> p.toString().endsWith(".txt"));
    }
    ...
    public static void findExamples() {
        System.out.println("Java files under project root");
        FolderUtils.findPathsInTree(".", (path, attrs) -> path.toString().endsWith(".java"));
        System.out.println("Folders under project root");
        FolderUtils.findPathsInTree(".", (path, attrs) -> attrs.isDirectory());
        System.out.println("Large files under project root");
        FolderUtils.findPathsInTree(".", (path, attrs) -> attrs.size() > 10000);
    }
}
