...
/**
 * Writes to a file from a List in one fell swoop. Works in either Java 7 or Java 8, unlike the file
...
public class WriteFile1 {
    public static void main(String[] args) throws IOException {
        ...
        Path path = Paths.get("build/example-output/io/file-write-test.txt");
