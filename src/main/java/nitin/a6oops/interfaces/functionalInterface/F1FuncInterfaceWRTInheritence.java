package nitin.a6oops.interfaces.functionalInterface;
...
interface ChildFuncInterfaceWRTInheritence extends FuncInterfaceWRTInheritence {
    ...
    // In the child interface we can’t define any new abstract methods otherwise child interface
    // won’t be Functional
    // Interface and if we are trying to use @Functional Interface annotation then compiler gives an
    // error message.
    /* public void m2(); */
