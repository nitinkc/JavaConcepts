...
public class Example {
    ...
    public static void main(String[] args) {
        ...
        Display<Integer> displayDeclaredHere =
                (a, b) -> System.out.println("method reference in java 8 : " + (a + b));
        displayDeclaredHere.displayResults(5, 55);

        // extracted method
        Display displayExtractedSameClass =
                getDisplay(); // this::getDisplay works with non-static classes
        ...
        Display<Integer> displayInstanceMethodParticularObject =
                ((a, b) ->
                        obj.myMethod(a, b)); // putting the definition in a5object of another class
        // Calling the method inside the functional interface Display
        displayInstanceMethodParticularObject.displayResults(1, 3);

        Display<Integer> displayReferenceInstanceMethodParticularObject =
                obj::myMethod; // calling the same via method reference
