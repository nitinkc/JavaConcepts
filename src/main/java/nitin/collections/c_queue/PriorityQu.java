...
/**
 * Heaps are represented using Priority Queue. It gives O(1) seek time add(E e) Inserts the
 * specified element into this priority queue. offer(E e) Inserts the specified element into this
 * priority queue poll() Retrieves and removes the head of this queue, or returns null if this queue
 * is empty.
 */
