...
public abstract class M2Abstract {
    ...
    // abstract call cannot be instantiated. Thus if we dont want a class to be instantiated, declare it as abstract.

    // If a class has atleast one abstract method, The class has to be declared as abstract.
