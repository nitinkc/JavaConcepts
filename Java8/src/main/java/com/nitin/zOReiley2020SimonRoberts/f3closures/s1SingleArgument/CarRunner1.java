package com.nitin.zOReiley2020SimonRoberts.f3closures.s1SingleArgument;
...
class CarRunner1 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("************ getGasLevelCarCriterion with value of threshold being passed from method to the Lambda ************");
