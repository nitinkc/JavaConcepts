...
public class A0DefiningCompletableFuture {
    ...
    public static void main(String[] args) {
        ...
        CompletableFuture<String> stringCompletableFuture = CompletableFuture.supplyAsync(() -> getData(dataFetchService));

        stringCompletableFuture
                .thenAccept(greetings -> logMessage("Message received from supply Async: " + greetings));
