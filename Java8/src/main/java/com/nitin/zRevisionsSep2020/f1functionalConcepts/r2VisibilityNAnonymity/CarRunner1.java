package com.nitin.zRevisionsSep2020.f1functionalConcepts.r2VisibilityNAnonymity;
...
class CarRunner1 {
  ...
  public static void main(String[] args) {
    ...
    showAll(getCarsByCriteria1(cars, Car1.getGasLevelCarCriterion(7)));//****** Not a Singleton ******
