...
public class SampleIntraStatLine {
    public static IntraStatsLine getIntraStatsLine() {
        EventComments eventComments = EventComments.builder()
                .facilityId("11019")
                .orderId("5b571d0a-1124-45b2-9985-373799d97a96")
                .sectionName(null)
                .someStats(Collections.singletonList(SomeStats.builder()
        ...
        EventComments eventComments2 = EventComments.builder()
                .facilityId("11019")
                .orderId("5b571d0a-1124-45b2-9985-373799d97a96")
                .sectionName(null)
                .someStats(Collections.singletonList(SomeStats.builder()
