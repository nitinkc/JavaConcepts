package nitin.a6oops.interfaces.functionalInterface.PredefinedFunctionalInterfaces;
...
/**
 * Created by Nitin Chaurasia on 1/30/18 at 5:41 PM. A predicate is a function with a single
 * argument and returns boolean value. Predicate interface is present in Java.util.function package
 *
 * <p>It’s a functional interface and it contains only one method i.e., test()
 */
