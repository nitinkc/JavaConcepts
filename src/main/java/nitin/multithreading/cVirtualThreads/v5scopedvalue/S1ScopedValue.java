...
public class S1ScopedValue {
    ...
    public static void main(String[] args) throws Exception {
        ...
        boolean result //bind a key (studentScopedValue) to a value (hp) with an operation op (handleUser())
            = ScopedValue.callWhere(studentScopedValue, hp, S1ScopedValue::handleUser);//using a callable
