package nitin.zOReiley2020SimonRoberts.f2functionalConcepts.r4GivingTypeToALambda;
...
class CarRunner1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "************ Passing Lambda. The method argument decides the type of the Lambda expression ************");
        ...
        // ((CarCriteria1)(c -> c.getColor().equals("Red"))) is an a5object reference of type
        // CarCriteria1 and thus the test
        // method can be invoked.
        boolean b1 =
                ((CarCriteria1) (c -> c.getColor().equals("Red")))
                        .test(Car1.withGasColorPassengers(0, "Red"));
        ...
        boolean b2 =
                ((Strange) ((Car1 c) -> c.getColor().equals("Red")))
                        .anotherTestStuff(Car1.withGasColorPassengers(0, "Red"));
