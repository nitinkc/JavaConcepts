 ...
 *
 * <p>The a10collections Utility Class provides the method to make a a_list FINAL
 * Collections.unmodifiableList(a_list) READ ONLY. Throws UnsopportedOperationException
 */
