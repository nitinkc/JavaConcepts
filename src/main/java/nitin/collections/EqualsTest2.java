...
public class EqualsTest2 {
    ...
    public static void main(String[] args) {
        ...
        if (leenaJacob.equals(
                leena)) // these 2 objects are same in the eyes of equals() method, but not in the
            // eyes of ==
            System.out.println("Both are equal in the eyes of equals() method");
        else System.out.println("Both are Unequal n the eyes of equals() method");

        if (leenaJacob == leena) // these 2 objects are different in the eyes of ==
        System.out.println("Both are equal n the eyes of == method");
        else System.out.println("Both are Unequal n the eyes of == method");

        if (leejac.equals(leena)) // leejac refers to leena so there is only one a5object
        System.out.println("Both are equal");
        else System.out.println("Both are UNequal");
