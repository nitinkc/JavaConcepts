package java.zCoreServletsTraining.t4FileIO.fileIO.writefiles;
...
public class WriteFile2 {
  public static void main(String[] args) {
    ...
    int numLines = 10;
    Path path = Paths.get("Java8/src/main/java/com/nitin/zCoreServletsTraining/t4FileIO/fileIO/output-file-2.txt");
