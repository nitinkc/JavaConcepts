...
public class C6FlatMapping {
                ...
                employees
                        ...
                        .collect(groupingBy(EmployeeSimple::getAge,
                                        mapping(EmployeeSimple::getName,
                                                ...
                                                Collectors.flatMapping(name -> List.of(name.split("")).stream(), toList())
                                                //)
                                        )
                                )
                        )
    ...
    private static void one2manyFlatMap(List<Integer> numbers) {
        ...
        List<Integer> one2manyflatMap = numbers.stream()
    ...
    private static void one2Many(List<Integer> numbers) {
        ...
        List<List<Integer>> one2many = numbers.stream()
    ...
    private static void one2one(List<Integer> numbers) {
        ...
        List<Integer> one2one = numbers.stream()
