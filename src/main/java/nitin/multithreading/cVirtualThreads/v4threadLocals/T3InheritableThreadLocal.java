...
public class T3InheritableThreadLocal {
    ...
    public static final InheritableThreadLocal<Student> studentInheritableThreadLocal =
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        studentInheritableThreadLocal.set(
                Student.builder()
                        .name("Harry Potter")
                        .build()); // First getting the parent object then mutating it.
                ...
                Thread.ofVirtual()
                        .start(
                                () -> {
                                    ...
                                    logShortMessage(
                                            "Initial => " + studentInheritableThreadLocal.get());
                                    // This DOES NOT CHANGE THE PARENT VALUE
                                    // studentInheritableThreadLocal.set(new Student("Ron
                                    // Weasley"));//Creating a new instance of Student and assigning
                                    // to the child thread.
                                    studentInheritableThreadLocal
                                            .get()
                                            .setName("Ron Weasley"); // First getting the parent
                                    // object then mutating it.
                                    logShortMessage(
                                            "Final => " + studentInheritableThreadLocal.get());
                                });
