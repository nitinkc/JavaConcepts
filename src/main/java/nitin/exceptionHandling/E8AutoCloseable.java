 ...
 *
 * <p>Java Commits to closing automatically any resource opened in the try block. For this reason
 * the resource must be closeable!!
 *
 * <p>Autocloseable interface has only one method to implement close()!!
 *
