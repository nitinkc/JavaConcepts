package java8.zCoreServletsTraining.t4FileIO.fileIOEx2;
...
public class FileIOExamples {
  public static void main(String[] args) {
    String filename = "Java8/src/main/java/com/nitin/zCoreServletsTraining/t4FileIO/fileIOEx2/enable1-word-list.txt";
