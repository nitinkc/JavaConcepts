...
public class S3ObjectGraphSerialization {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        //Serializing Object
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(new File("src/com/nitin/serialization/serialObjectGraph.txt")));
        oos.writeObject(new Animal());
        oos.close();

        //Deserialization
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream(new File("src/com/nitin/serialization/serialObjectGraph.txt")));
