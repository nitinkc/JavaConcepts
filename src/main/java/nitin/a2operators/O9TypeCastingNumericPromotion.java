...
/**
 * Created by Nitin Chaurasia on 12/27/16 at 1:03 AM. 2 Types of Numeric Type Casting Implicit Type
 * Casting : Also known as WIDENING OR UP-CASTING Compiler is responsible for typecasting. Happens
 * when assigning smaller data type value to a bigger data type variable No loss of information
 * Explicit Type Casting Also known as NARROWING OR DOWN-CASTING Programmer is responsible Happens
 * when assigning bigger data type value to a smaller data type variable Chance of loss of
 * precision/info.
 */
