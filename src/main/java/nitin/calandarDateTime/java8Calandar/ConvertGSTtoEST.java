...
public class ConvertGSTtoEST {
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println(
                getFormattedOutputDateTimeString(
    ...
    private static String getFormattedOutputDateTimeString(
            String dateTime,
            String inputDateTimePattern,
        ...
        DateTimeFormatter inputFormatter =
                DateTimeFormatter.ofPattern(inputDateTimePattern)
                        .withZone(
                                ZoneOffset.UTC); // redundant if the input date-time string already
        // contains the offset information (+00)
        // useful when the String doesn't have Zone Id like mentioned "2024-03-10 07:00:00"  and is
        // assumed to be from UTC

        // Output Formatter
        DateTimeFormatter outputFormatter = DateTimeFormatter.ofPattern(outputDateTimeFormat);

        return ZonedDateTime.parse(dateTime, inputFormatter) // Returns ZonedDateTime
