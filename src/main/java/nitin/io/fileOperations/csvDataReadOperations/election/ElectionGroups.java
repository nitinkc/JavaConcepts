...
/**
 * @author Created by nichaurasia Created on Wednesday, September/30/2020 at 11:22 PM
 */
public class ElectionGroups {
    private static final Comparator<Map.Entry<String, Integer>> valueOrder =
            Map.Entry.<String, Integer>comparingByValue().reversed();
    private static final Comparator<Map.Entry<String, Integer>> reversedValueOrder =
            valueOrder.reversed();
