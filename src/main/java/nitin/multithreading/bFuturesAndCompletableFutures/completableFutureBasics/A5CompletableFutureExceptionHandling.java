...
public class A5CompletableFutureExceptionHandling {
    ...
    public String async_call_exception_handle() {
        CompletableFuture<String> greetings =
                CompletableFuture.supplyAsync(() -> this.dataFetchService.greetingsService(1000));
        CompletableFuture<String> firstName =
                CompletableFuture.supplyAsync(() -> this.dataFetchService.firstNameService(1000));
        CompletableFuture<String> lastName =
                CompletableFuture.supplyAsync(() -> this.dataFetchService.lastNameService(1000));
                ...
                greetings
                        ...
                        .exceptionally(
                                (exception) -> {
                                    if (null != exception) {
                                        logShortMessage(
                                                "Found Exception after greetings"
