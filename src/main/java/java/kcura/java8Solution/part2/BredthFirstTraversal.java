package java.kcura.java8Solution.part2;

import java.kcura.oldSolution.part1.Data;
...
public class BredthFirstTraversal {
    private final Set<java.kcura.oldSolution.part1.Data> visited = new HashSet<java.kcura.oldSolution.part1.Data>();
    ...
    public void traverseGraph(Map<java.kcura.oldSolution.part1.Data, Set<java.kcura.oldSolution.part1.Data>> citiesAdjList, java.kcura.oldSolution.part1.Data root) {
        int currDistance = 0;
        ...
        while (inline.size() > 0) {
            ...
            for (java.kcura.oldSolution.part1.Data connections : citiesAdjList.get(currentCityDistance.data)) {
    ...
    private class CityDistance {
        int distance;
        java.kcura.oldSolution.part1.Data data;
