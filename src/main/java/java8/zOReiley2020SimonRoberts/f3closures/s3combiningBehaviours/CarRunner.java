package java8.zOReiley2020SimonRoberts.f3closures.s3combiningBehaviours;
...
class CarRunner {
  ...
  public static void main(String[] args) {
    ...
    Criteria<Car> notLever7 = Car.negate(level7);
    ...
    Criteria<Car> redORlevel7 = Car.or(isRed,level7);
