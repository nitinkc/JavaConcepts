...
/**
 * Created by Nitin Chaurasia on 12/28/16 at 1:04 AM. Declare a method with variable number of
 * Arguments Since V1.5 m(int... x) &amp; m(int x...) - ONLY TWO WAYS OF DECLARATION Only one
 * Var-Arg parameter is allowed, also it should be last - m(String s, int... x) internally its
