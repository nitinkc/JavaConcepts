 ...
 * This can be contolled by Customized Serialization
 */
public class S4CustomizedSerialization {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        //Serializing Object
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(new File("src/com/nitin/serialization/serialObjectCoustomized.txt")));
        Login l = new Login();
        ...
        //Deserialization
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream(new File("src/com/nitin/serialization/serialObjectCoustomized.txt")));
...
class Login implements Serializable {
    ...
    private void writeObject(ObjectOutputStream os) throws Exception{
        //perform default serialization (Nitin...null) 
