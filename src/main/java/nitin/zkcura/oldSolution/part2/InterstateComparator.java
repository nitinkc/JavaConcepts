 ...
 * the input file and thus it can safely be deduced that The total nmver of times an interstate name
 * appears in the input file is equal to the total number of different cities is passes through
 */
