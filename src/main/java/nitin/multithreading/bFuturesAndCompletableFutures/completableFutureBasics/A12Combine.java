...
public class A12Combine {
    public static void main(String[] args) {
        CompletableFuture<Double> radiusFuture = CompletableFuture.supplyAsync(() -> 1.0);//Returning a random number Asyncronously
        radiusFuture
                //.thenApply(radius ->  CompletableFuture.supplyAsync(() -> calculateArea(radius)))//Returns a completable future, not the value of it, java.util.concurrent.CompletableFuture@7106e68e[Completed normally]
