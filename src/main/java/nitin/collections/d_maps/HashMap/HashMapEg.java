...
public class HashMapEg {
    public static void main(String[] args) {
        ...
        System.out.println(m.get(new Cat())); //the get() method failed to find the Cat a5object that was inserted earlier.It's easy to see that Dog overrode equals() and hashCode() while Cat didn't.
