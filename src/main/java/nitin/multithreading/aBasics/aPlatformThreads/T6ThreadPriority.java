...
public class T6ThreadPriority {
     ...
     *
     * <p>All Child Threads inheriting from the parent has same priority With Same Priority,
     * un-deterministic order Priority Varies from 1 to 10 (10 being the most)
     */
