package com.nitin.a13multithreadingEnhancements.aThreadGroups;
...
public class cThreadGroupMethods {
    public static void main(String[] args) {
        ...
        try { // After 10 secs, both active threads will be gone as 5000 is the sleep time for MyReentrantDemoThread
