 ...
 * tutorials on JSF 2, PrimeFaces, Ajax, JavaScript, jQuery, GWT, Android, Spring, Hibernate, JPA,
 * RESTful Web Services, Hadoop, Spring MVC, servlets, JSP, Java 8 lambdas and streams (for those
 * that know Java already), and Java 8 programming (for those new to Java)</a>.
 */
