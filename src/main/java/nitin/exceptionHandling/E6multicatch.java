...
/**
 * Created by Nitin C on 3/5/2016. multi-catch block In Java 7, they introduce the the ability to
 * catch multiple exceptions in the same catch block. catch (FileNotFoundException | IOException e)
 * redundant exceptions gives the error. Error MULTI-CATCH Must be disjoint
 *
