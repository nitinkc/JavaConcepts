...
public class O3applyMapWithOptional {
    ...
    private static void demo2() {
        ...
        for (String city : cities) {
            // Another Example, in a loop, adding city name from the Object obj and appending a
            // comma if the city exist, else leaving the city name.
            String test1 =
                    Optional.ofNullable(city).isPresent() ? city.toUpperCase() + "," : "NO_CITY";
    ...
    private static void simpleDemo() {
        ...
        String emptyMap = emptyStringOptional.map(x -> x.toUpperCase()).orElse("Empty Map");
