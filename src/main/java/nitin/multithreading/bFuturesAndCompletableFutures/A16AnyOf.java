...
public class A16AnyOf {
    public static void main(String[] args) {
        ...
        var future1 = CompletableFuture.supplyAsync(() -> dataFetchService.microTask("Harry Potter", 2, true));
        var future2 = CompletableFuture.supplyAsync(() -> dataFetchService.microTask("Ron Weasley", 5, true));
        var future3 = CompletableFuture.supplyAsync(() -> dataFetchService.microTask("Hermione Granger", 6, true));
        var future4 = CompletableFuture.supplyAsync(() -> dataFetchService.microTask(Faker.instance().harryPotter().character(), 1, true));
