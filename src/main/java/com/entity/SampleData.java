...
/**
 * @author Created by nichaurasia Created on Tuesday, September/29/2020 at 10:04 PM
 */
public class SampleData {
    ...
    public static List<Student> STUDENTS =
            Arrays.asList(
                    new Student(
                            ...
                            Ethnicity.NORTHAMERICAN,
                            new Address("121 Crazy Street", null, "Sanford", "FL", "USA", 32771),
                            Long.valueOf(1100112233),
                            StudentOf.ENGINEERING),
                    new Student(
                            "Abraham",
                            "Lincoln",
                            new Date("01/01/1985"),
                    ...
                    new Student(
                            ...
                            Ethnicity.ASIAN,
                            new Address(
                                    "121 Crazy Street", null, "Porbandar", "GJ", "India", 486001),
                    ...
                    new Student(
                            ...
                            Ethnicity.SOUTHAMERICAN,
                            new Address(
                                    "121 Crazy Street", null, "MAchu pichu", "MP", "Peru", 589652),
                            Long.valueOf(1100112233),
                            StudentOf.ENGINEERING),
                    new Student(
                            "Abbott",
                            ...
                            Long.valueOf(1100112233),
                            StudentOf.ENGINEERING));
    private static final List<EmployeeSimple> SIMPLE_EMPLOYEES =
            Arrays.asList(
    ...
    private SampleData() {} // Uninstantiatable class
