package nitin.zkcura.java8Solution.part1;
...
public class Driver8 {
        ...
        while (itr.hasNext()) {
            ...
            for (int i = 0; i < temp.size(); i++) {
                ...
                if (!interstateCountMap.containsKey(currInterstateName)) {
                    ...
                    interstateCountMap.put(
                            currInterstateName, interstateCountMap.get(currInterstateName) + 1);
                }
            }
        }
    ...
    private static void writeCitiesByPopulation(List<Data> list) {
        ...
        list.sort(
                Comparator.comparing(Data::getPopulation)
                        .reversed()
                        ...
                        public int compare(String o1, String o2) {
                            ...
                            if (interstateNumber1 > interstateNumber2) {
                                ...
                                throw new IllegalArgumentException(
                                        "Two Interstates with same name in a Same City");
                            }
                        }
                    });
