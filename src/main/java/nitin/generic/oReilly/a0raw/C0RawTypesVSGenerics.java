...
public class C0RawTypesVSGenerics {
    ...
    private static void genericCollection() {
        ...
        // Gives a compile time exception - java: incompatible types: java.time.LocalDate cannot be
        // converted to java.lang.String
        // strings.add(LocalDate.now());

        // Still a chance of Null pointer exception. Use null check before String operation of
        // s.length()
        strings.add(null);
    ...
    private static void rawCollection() {
        ...
        // strings.add(LocalDate.now());
        // Invokes ClassCastException: class java.time.LocalDate cannot be cast to class
        // java.lang.String
