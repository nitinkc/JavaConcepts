...
public class PrimeStream {
    ...
    /**
     * Makes an "infinite" (unbounded) stream of consecutive prime numbers. This method is for when
     * you want to control the size-limiting steps later. The more common usage is the next method,
     * where you limit the size in the call to the original method.
     */
