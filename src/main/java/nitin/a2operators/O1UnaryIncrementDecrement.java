...
/**
 * Created by Nitin Chaurasia on 12/28/16 at 8:23 PM. Pre-Increment ++x Post-Increment x++
 * Pre-Decrement --x Post-Decrement x++
 *
 * <p>Nesting not possible ++(--x) -> Compile time error Can be applied to all primitive type except
 * boolean
 */
public class O1UnaryIncrementDecrement {
    public static void main(String[] args) {
        ...
        // Can be applied to all primitive type except booleanCan be applied to all primitive type
        // except boolean
        char ch = 'a';
