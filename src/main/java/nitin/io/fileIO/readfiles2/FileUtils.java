...
/**
 * Prints all palindromes and all n-length palindromes. Uses the second file-reading variation,
 * where the code is split into a file-processing method and a stream-processing method, but code in
 * the file-processing method is repeated from example to example.
 */
